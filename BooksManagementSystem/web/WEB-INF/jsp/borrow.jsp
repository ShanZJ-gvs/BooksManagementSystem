                    ...
                    <div class="col">
                        <form class="d-none d-sm-inline-block mr-auto ml-md-3 my-2 my-md-0 mw-100 navbar-search">
                            <div class="form-row" style="height: 96px;">
                                <div class="col d-xl-flex justify-content-xl-start align-items-xl-center"><span class="d-xl-flex justify-content-xl-center align-items-xl-center" style="width: 51px;">姓名</span><input type="text" class="form-control" style="width: 107px;" /></div>
                                <div class="col d-xl-flex justify-content-xl-start align-items-xl-center"><span class="d-xl-flex justify-content-xl-center align-items-xl-center" style="width: 53px;">书名</span><input type="text" class="form-control" /></div>
                                <div class="col d-xl-flex justify-content-xl-start align-items-xl-center" style="width: 202px;"><span class="d-xl-flex justify-content-xl-center align-items-xl-center" style="width: 51px;">状态</span><input type="text" class="form-control" style="width: 107px;" /></div>
